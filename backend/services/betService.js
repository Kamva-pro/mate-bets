...
const supabase = require('../supabase-client'); // Import the Supabase client
const moment = require('moment'); // For generating bet ID based on timestamp

const placeBet = async ({ opponentEmail, chessUsername, stake, gameFormat, gameSeries, opp_chessUsername }) => {
    try {
        // Step 1: Fetch opponent data
